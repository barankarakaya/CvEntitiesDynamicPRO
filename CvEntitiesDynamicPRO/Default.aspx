<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvEntitiesDynamicPRO.Default" %>
...
<html lang="zxx">
<head>
    <title>Baran Karakaya Software Developer</title>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Baran Karakaya</a></h1>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız"></asp:TextBox>
